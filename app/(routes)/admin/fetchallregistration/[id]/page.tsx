        ...
        {/* <div className="flex flex-wrap -mx-2">
          ...
          <div className="w-full md:w-1/2 px-2">
            <div className="bg-gradient-to-r from-blue-500 to-teal-500 rounded-lg shadow-lg p-6 text-white transform transition duration-500 hover:scale-105">
              ...
              <ul>
                <li className="mb-2 text-lg font-medium">Total # of PreEcolier: <span className="font-bold">{preEculier}</span></li>
                <li className="mb-2 text-lg font-medium">Total # of Ecolier: <span className="font-bold">{eculier}</span></li>
