export interface CashPrizesCertificateData {
  name: string;
  abbreviation: string;
  data: Data[];
}
...
export const diamondImpact: CashPrizesCertificateData = {
  name: "Diamond Academic Impact Award - Cash Prize Rs. 14,000",
  abbreviation: "DAIA",
  data: [
    {
      c_Name: "AMBER SHAHEEN",
      schoolId: 832,
      schoolName: "SILVER OAKS SCHOOLS & COLLEGES",
    },
    {
      c_Name: "ZAREEN FATIMA",
      schoolId: 1035,
