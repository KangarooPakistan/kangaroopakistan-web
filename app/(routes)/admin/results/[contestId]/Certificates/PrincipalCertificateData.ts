...
export const oaepcertificateData: PrincipalCertificateData = {
  ...
  data: [
    ...
    {
      p_Name: "PROF. MUHAMMAD IMRAN NAIK",
      schoolId: 397,
    ...
    {
      p_Name: "MOHSIN MUBARAK",
      schoolId: 1042,
      schoolName: "MULTAN PUBLIC SCHOOL BOYS",
    },
    {
      p_Name: "SHOMAILA BOKHARI",
      schoolId: 1104,
