...
import { CashPrizesCertificateData } from "../Certificates/CashPrizes";
...
type Props = {
  contestName: string;
  bronzeImpact: CashPrizesCertificateData;
  silverImpact: CashPrizesCertificateData;
