    ...
    {schoolDetails.map((school, index) => (
      <Page key={school.schoolId} size="A4" style={styles.page}>
        ...
        <View style={styles.addressBlock}>
          ...
          <Text style={[styles.text, styles.bold]}>{school.schoolName}</Text>
          <Text style={styles.subText}>School Address: {school.schoolAddress}</Text>
          <Text style={styles.subText}>SchoolId: {school.schoolId}</Text>
          <Text style={styles.subText}>Tel: {school.schoolPrinPhone} / {school.schoolCorPhone}</Text>
        </View>
        </View>
        ...
        <View style={styles.fromBlock}>
          ...
          <Text style={styles.subText}>Cell: 0321-8403033 / 0333-2111399</Text>
        </View>
        <View></View>
