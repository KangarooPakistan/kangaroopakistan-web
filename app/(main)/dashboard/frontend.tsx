...
const Frontend = () => {
  ...
  return (
    <div className="container mx-auto py-10">
      ...
      {mySession && role === "User" && (
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4 mx-auto py-10">
          <div className="bg-white rounded-2xl shadow-gray-800 shadow-md w-full m-2 flex flex-col h-full">
            ...
            <p className="text-purple-600 text-justify p-4 font-bold text-md md:text-xl flex-grow">
              ...
              BANK LTD
              <br /> TITLE: INNOVATIVE LEARNING <br /> ACC. # 077 1005053360001 <br />{" "}
